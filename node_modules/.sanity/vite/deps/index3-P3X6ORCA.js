import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-KCIVL36P.js";
import "./chunk-XQPY2D2X.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
function PaneRouterProvider(props) {
  ...
  $[8] !== createNextRouterState || $[9] !== resolvePathFromState || $[10] !== siblingIndex ? (t4 = (nextParams) => {
    const nextRouterState_1 = createNextRouterState((siblings, item) => [...siblings.slice(0, siblingIndex), __spreadProps$3(__spreadValues$3({}, item), {
      params: nextParams
  ...
  $[12] !== modifyCurrentGroup || $[13] !== siblingIndex ? (t5 = (nextPayload) => {
    modifyCurrentGroup((siblings_0, item_0) => [...siblings_0.slice(0, siblingIndex), __spreadProps$3(__spreadValues$3({}, item_0), {
      payload: nextPayload
  ...
  $[15] !== modifyCurrentGroup || $[16] !== siblingIndex ? (t6 = (nextParams_0) => {
    modifyCurrentGroup((siblings_1, item_1) => [...siblings_1.slice(0, siblingIndex), __spreadProps$3(__spreadValues$3({}, item_1), {
      params: nextParams_0
...
async function resolveIntent(options) {
  const resolvedPaneCache = /* @__PURE__ */ new Map(), resolvePane = createPaneResolver((nextFn) => (unresolvedPane, context, flatIndex) => {
    ...
    params: __spreadProps$2(__spreadValues$2({}, (0, import_omit.default)(options.params, ["id"])), {
  ...
  async function traverse({
    ...
    const _a = params, {
      id: targetId,
      type: schemaTypeName
    } = _a, otherParams = __objRest$1(_a, [
      "id",
      "type"
    ]), resolvedPane = await firstValueFrom(resolvePane(unresolvedPane, {
      id: currentId,
      splitIndex: 0,
      parent: parent2,
      path,
    ...
    return resolvePane(unresolvedPane, context, current.flatIndex).pipe(
      ...
      switchMap((paneNode) => {
        const resolvedPaneMeta = __spreadProps$1(__spreadValues$1({
          ...
          const loadingPanePath = [...context.path, ...rest.slice(restIndex).map((_, currentIndex) => `[${i.flatIndex + currentIndex}]`)];
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-PBLQ6VTN.js")),
  document: (0, import_react.lazy)(() => import("./pane-6ARPLPIW.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-6ARPLPIW.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-UZ3PYFBR.js"))
};
var StructureToolPane = (0, import_react.memo)(function(props) {
  ...
  } = _b, prev = __objRest(_b, [
    "params",
    "payload"
  ]), _d = _c2, {
    params: nextParams = {},
    payload: nextPayload = null
  } = _d, next = __objRest(_d, [
    "params",
    "payload"
  ]);
...
var DocumentTitle = (props) => {
  const $ = (0, import_react_compiler_runtime.c)(7), {
    ...
    t
  } = useTranslation(structureLocaleNamespace), isNewDocument = !(editState != null && editState.published) && !(editState != null && editState.draft), documentValue = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published), schemaType = schema.get(documentType), {
    value,
...
var StructureTool = (0, import_react.memo)(function(t0) {
  ...
  }, t7 = [pushToast], $[8] = pushToast, $[9] = t6, $[10] = t7) : (t6 = $[9], t7 = $[10]), (0, import_react.useEffect)(t6, t7), !((_a = schema._original) != null && _a.types.some(_isCustomDocumentTypeDefinition))) {
    let t82;
...
//# sourceMappingURL=index3-P3X6ORCA.js.map
